...
//        id	alt	image_path	watermark	size - (o)riginal, (m)edium, (s)mall
        ...
        DB::table('photos')->insert(['id' => 7, 'alt' => 'Banner Photo 1', 'image_path' => 'images/banners/banner-01.jpeg', 'size' => 'original']);
        DB::table('photos')->insert(['id' => 8, 'alt' => 'Banner photo 2', 'image_path' => 'images/banners/banner-02.jpeg', 'size' => 'original']);
