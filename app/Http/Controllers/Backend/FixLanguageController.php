...
// app()->call([$controller, 'fixAuction'], []);
...
class FixLanguageController extends Controller
{
    ...
    public function fixAuction()
    {

        // print $this->big2gb("彰化一整天的blog-UTF8繁體轉簡體function範例");
        $details = App\AuctionItemDetail::where('lang', 'trad')->get();
        ...
        foreach($details as $detail) {
            ...
            $simDetail->misc = $this->big2gb($detail->misc);
            $simDetail->provenance = $this->big2gb($detail->provenance);
            $simDetail->post_lot_text = $this->big2gb($detail->post_lot_text);
