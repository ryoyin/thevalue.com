<head>
    ...
    <!-- custom -->
    <link href="{{ asset('css/web.css') }}?refresh=201705081331" rel="stylesheet">
...
//        console.log(site_root);
    ...
    <script src="{{ asset('js/general.js') }}?refresh=20170425"></script>
    ...
    <script>
        (adsbygoogle = window.adsbygoogle || []).push({
            google_ad_client: "pub-8545127753274353",
