            ...
            @if(!$appMode)
                <li class='pull-right'>
                    <ul class='ul-clean share'>
                        ...
                        <li><a onclick="updateCounter('{{ $slug }}', 'share_counter')" href="https://www.facebook.com/share.php?u={{ route("frontend.article", ['slug' => $slug]) }}&t={{ $articleDetails['title'] }}&pic={{ asset($article_photo) }}" target="_blank"><i class='fa fa-facebook-f' aria-hidden='true'></i></a></li>
